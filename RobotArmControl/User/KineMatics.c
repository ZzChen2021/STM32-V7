...
/*
*********************************************************************************************************
*	函 数 名: convertToHomogeneousMatrix
...
*********************************************************************************************************
*	函 数 名: linspace
*	功能说明: 将t(output)向量归一化,限定在(0,1)
*	形    参：
*               float *output ：保存归一化后的向量
*               float start：归一化下限
*               float end：归一化上限
*               float num：向量维度
*	返 回 值: 无
